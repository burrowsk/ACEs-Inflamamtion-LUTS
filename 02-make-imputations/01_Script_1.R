...
#===============================================================================
# This is an adaptation of Script_1.R created by Lotte Houtepen
# Kimberley Burrows
# Completed:
# ALSPAC syntax file for data last run:
#===============================================================================
...
#here()
setwd("C:/Users/epwkb/OneDrive - University of Bristol/MHI/02-Inflammation-mediation/02-analysis")
...
# Notes: -----------------------------------------------------------------------
# I reconstructed the data from syntax file instead of using the old data
# variables:
#          fa3322, fa3327, kz029 (replaced with bestgest), mult (?)
# no longer available in ALSPAC
# "mz001" replaced by "preg_in_core"
#-------------------------------------------------------------------------------
...
### A. Read in alspac data compiled using Stata (alspac syntax file)
# Most variables are factors
alspac.table_ACE <- read_dta('data/pheno_aces.dta')
alspac.table_ACE <- zap_missing(alspac.table_ACE) # Zap Stata special missing (-99 etc.)
alspac.table_ACE <- zap_formats(alspac.table_ACE) # Zap Stata format attributes
alspac.table_ACE <- zap_label(alspac.table_ACE) # Zap Stata variable labels
alspac.table_ACE <- as_factor(alspac.table_ACE) # Haven convert dbl+lbl to factors
#alspac.table_ACE <- droplevels(alspac.table_ACE) # Drop empty levels

class(alspac.table_ACE)
dim(alspac.table_ACE) # 13741 participants with 766 variables
class(alspac.table_ACE$aln) # ALN needs to be numeric for merges

### B. Read in dataframe with info on ACE variables
adv_description<-data.frame(readxl::read_excel(
  'data/SI_data1_ACE_definitions_overtime.xlsx', sheet = 'ACE variables',col_names=TRUE))
...
impute_ACE<-
  c("c804", "kz030", "bestgest", "dw002", "dw042", "a006", "mz028b",
        ...
        "t1360", "t1362", "fa1360", "fa1362", "t5404", "t3327",
        "t3255", "t5300", "t5305", "t5320", "t5340", "t5345", "t5360",
        "t5365", "t5380", "t5385", "fa5404", "t2035", "fa2035",
...
str(alspac.table_ACE, list.len=ncol(alspac.table_ACE))
...
table(alspac.table_ACE$j_sc_ptnr_pp, alspac.table_ACE$j_sc_m) # Matched with Stata

#===============================================================================
# Code Block 3: Create binary maternal smoking during pregnancy variables
#
#===============================================================================
...
alspac.table_ACE$matsmok_tri3_c <-
  ifelse(alspac.table_ACE$c482 == 'None', 0, 1)
alspac.table_ACE$matsmok_tri3_e <-
  ifelse(alspac.table_ACE$e178 == 'Not at all', 0, 1)

alspac.table_ACE$matsmok_tri1<-
  as.factor(alspac.table_ACE$matsmok_tri1)
alspac.table_ACE$matsmok_tri2<-
  as.factor(alspac.table_ACE$matsmok_tri2)
alspac.table_ACE$matsmok_tri3_c<-
  as.factor(alspac.table_ACE$matsmok_tri3_c)
alspac.table_ACE$matsmok_tri3_e<-
  as.factor(alspac.table_ACE$matsmok_tri3_e)
...
## D. save
loc_out='data/'
save(binary_alspacKids_ACE_data,file= paste0 (loc_out, "binary_alspacKids_ACE_data.RData"))
...
for(var in ACE_var){
  message(var)
print(table(binary_alspacKids_ACE_data[[var]]))
}
...
#impute_ACE<-
#    c("a006", "a525", "a600",
#      "b032", "b106", "b107", "b122", "b123", "b370", "b578", "b587", "b593", "b597", "b598", "b608", "b701", "b702", "b714",
#      "c093", "c101", "c472", "c520", "c522", "c600", "c645a", "c666a",  "c804",
#      "d152", "d167", "d168", "d169", "d170", "d790", "dw002", "dw042",
#      "fa1360", "fa1362", "fa2035", "fa3308", "fa3316", "fa3321", "fa3325", "fa3326", "fa3328", "fa3333", "fa3334",
#      "fa5402", "fa5404", "fa5406", "fa5410", "fa5411", "fa5510",
#      "kz021", "kz030", "mz028b",
#      "pa172", "pa187", "pa188", "pa189", "pa190",
#      "pb098", "pb130", "pb168", "pb177", "pb183",  "pb187", "pb188a",  "pb260", "pb325a", "pb342a",
#      "t1360", "t1362", "t2035", "t3255", "t3308", "t3316", "t3321", "t3322", "t3325", "t3326", "t3327", "t3328", "t3336", "t3337",
#      "t5300", "t5305", "t5320", "t5340", "t5345", "t5360", "t5365", "t5380", "t5385",
#      "t5402", "t5404", "t5406", "t5410", "t5412", "t5510",
#      "ypa5005_dup", "ypa5007_dup", "ypa5009_dup", "ypa5011_dup", "ypa5013_dup", "ypa5015_dup", "ypa5017_dup", "ypa5050",
#      "bestgest", "sc_household_18wgest",
#      "b665","b667","c482","e178",
#      "fa5510_dup", "t5510_dup"
#      ) # IN ALPHA ORDER
# ------------------------------------------------------------------------------
