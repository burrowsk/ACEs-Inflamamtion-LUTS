...
log_ui <- readLines("B:/Kim/02-Inflammation-mediation/02-analysis/data/HPC/mediation_logs/all_logs_ACE_score_UI_mod2.txt")
log_bw <- readLines("B:/Kim/02-Inflammation-mediation/02-analysis/data/HPC/mediation_logs/all_logs_ACE_score_Bedwetting_mod2.txt")
log_dw <- readLines("B:/Kim/02-Inflammation-mediation/02-analysis/data/HPC/mediation_logs/all_logs_ACE_score_Daywetting_mod2.txt")
log_freq <- readLines("B:/Kim/02-Inflammation-mediation/02-analysis/data/HPC/mediation_logs/all_logs_ACE_score_Frequency_mod2.txt")
log_noct <- readLines("B:/Kim/02-Inflammation-mediation/02-analysis/data/HPC/mediation_logs/all_logs_ACE_score_Nocturia_mod2.txt")
log_urgency <- readLines("B:/Kim/02-Inflammation-mediation/02-analysis/data/HPC/mediation_logs/all_logs_ACE_score_Urgency_mod2.txt")
log_void_post <- readLines("B:/Kim/02-Inflammation-mediation/02-analysis/data/HPC/mediation_logs/all_logs_ACE_score_Voiding_postponement_mod2.txt")
log_void_vol <- readLines("B:/Kim/02-Inflammation-mediation/02-analysis/data/HPC/mediation_logs/all_logs_ACE_score_Voiding_volume_mod2.txt")
...
gtsave(med_ac_luts, file = paste0(Tables,"table_s11.docx"))
